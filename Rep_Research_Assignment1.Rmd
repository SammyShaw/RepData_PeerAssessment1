...
### Part 1. What is the total number of steps taken each day?
...
### Part 4. Make a histogram of the total number of steps taken each day and calculate and report the mean and median total number of steps taken per day
```{r}
